include("qtsp_window_update_protocol.jl")
...
function two_node_qtsp_window_update_probe_runner(prot::QTSPWindowUpdateProtocol,
        plus_w, minus_w, n, window_info)
    ...
    probe_case = (;
        ...
        classical_delay=prot.classical_delay,
        quantum_delay=prot.quantum_delay,
        initial_delay=0.0,
...
function build_two_node_qtsp_window_update_protocol(; target_tp=QTSP_TARGET_TP,
    ...
    build_qtsp_window_update_protocol(;
        ...
        sim_time,
        probe_repeats,
        probe_runner=two_node_qtsp_window_update_probe_runner,
        flow_uuid,
        chi,
        send_rate,
        distance_km,
...
function run_qtsp_window_update(; target_tp=QTSP_TARGET_TP,
        ...
        update_stepsize=qtsp_update_stepsize,
        werner_perturbation=qtsp_update_werner_perturbation)
    # build the network and protocol
    protocol = build_two_node_qtsp_window_update_protocol(;
        target_tp,
        iterations,
        initial_window_size,
        initial_werner_w,
