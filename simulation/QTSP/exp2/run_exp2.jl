include(joinpath(@__DIR__, "..", "run_qtsp_window_update.jl"))

###
# Experiment 2: sweep target throughput and initial controller state.
#
# This keeps the non-swept parameters aligned with simulation/qtsp/result2.txt.
# With iterations=10000 and T_W=2000.0, the derived sim_time is 2.0e7,
# matching result2.txt. Smaller iteration counts derive shorter sim times.
###

const EXP2_TARGET_THROUGHPUTS = (2.0)
